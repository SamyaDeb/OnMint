...
const DEFAULT_WORDS = ["ONMINT", "BUY NOW", "PAY LATER", "TRUST SCORE", "WEB3 CREDIT"]
...
export function ParticleTextEffect({ 
  ...
  // White color palette for particles
  const colors = [
    { r: 255, g: 255, b: 255 },   // Pure White
    { r: 245, g: 245, b: 245 },   // Off White
    { r: 235, g: 235, b: 235 },   // Light Gray White
    { r: 250, g: 250, b: 250 }    // Very Light White
  ]
  ...
  useEffect(() => {
    ...
    const performNextWord = (word: string, canv: HTMLCanvasElement) => {
      ...
      // Generate random color from OnMint palette
