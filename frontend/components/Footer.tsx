      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">OnMint</h3>
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Web3's First Trust-Based Payment Layer
            </p>
            <div className="flex space-x-4">
              <a href="https://github.com/OnMint" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white">
                <FaGithub size={20} />
              </a>
              <a href="https://twitter.com/OnMint" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white">
                <FaTwitter size={20} />
              </a>
              <a href="https://discord.gg/onmint" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white">
                <FaDiscord size={20} />
              </a>
              <a href="https://medium.com/onmint" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white">
                <FaMedium size={20} />
              </a>
            </div>
          </div>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8 dark:border-gray-800">
          <p className="text-sm text-center text-gray-500 dark:text-gray-400">
            &copy; {currentYear} OnMint. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
